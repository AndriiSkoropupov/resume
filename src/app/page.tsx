                    ...
                    <CardContent>
                        ...
                        <section className="mb-6">
                            ...
                            <ul className="list-disc list-outside ml-4 space-y-1">
                                ...
                                <li><strong>Frameworks:</strong> React, Redux, Vue, NestJS, NodeJS, SCSS, Material UI</li>
                                ...
                                <li><strong>Tools:</strong> RabbitMQ, RedisSMQ, GraphQL, Docker, Swagger, TelegrafJS, Git, Jira, Linux</li>
                            </ul>
                        </section>
                        ...
                        <section className="mb-6">
                            ...
                            <ul className="list-disc list-outside ml-4 space-y-1">
                                {/*<li><strong>Trading Bot Platform:</strong> High-frequency trading backend using NestJS, PostgreSQL, TypeORM.</li>*/}
                                ...
                                {/*<li><strong>baZOOka Telegram Bot:</strong> Telegram-based on-chain swap bot built with TelegrafJS, Redis, RabbitMQ.</li>*/}
                                ...
                                {/*<li><strong>Unlimited Trade:</strong> Synthetic leverage trading protocol (up to 100x), on-chain with custom Oracle integration.</li>*/}
                                ...
                                {/*<li><strong>Liquidity Management App:</strong> Auto-rebalancing bot for Uniswap v3 liquidity positions.</li>*/}
                                ...
                                {/*<li><strong>Custodial Wallet:</strong> Secure, microservice-architected crypto wallet with API, transfer queue, and wallet logic.</li>*/}
                                ...
                                {/*<li><strong>LENBOW Protocol:</strong> Lending, borrowing, and staking protocol with liquidation automation.</li>*/}
                                ...
                                {/*<li><strong>Stablecoin Protocol:</strong> Fully on-chain algorithmic stablecoin with peg security tools.</li>*/}
                                ...
                                {/*<li><strong>DEX Widget:</strong> Embeddable DEX UI built with VueJS and Solidity integration.</li>*/}
                                ...
                                {/*<li><strong>Concentrated Liquidity Bot:</strong> Smart contract + backend tool to rebalance Uniswap v3 LPs.</li>*/}
